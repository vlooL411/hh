...
const VacancyLoader = (): ReactElement => {
    const { vacancyloader, vacancyloader_logo, vacancyloader_description } = style
    const { vacancyloader_title, vacancyloader_salary, vacancyloader_employer, vacancyloader_area } = style

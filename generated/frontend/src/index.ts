...
export type LoginQuery = { __typename?: 'Query' } & {
	login?: Maybe<
		{ __typename?: 'UserSafe' } & Pick<UserSafe, 'userId' | 'username'>
	>;
};

export type VacancyInfoFragment = { __typename?: 'Vacancy' } & Pick<
	Vacancy,
	'id' | 'name'
> & {
		area?: Maybe<{ __typename?: 'Area' } & AreaInfoFragment>;
		salary?: Maybe<{ __typename?: 'Salary' } & SalaryInfoFragment>;
		employer?: Maybe<{ __typename?: 'Employer' } & EmployerInfoFragment>;
	};

export type VacancyInfoDescriptionFragment = { __typename?: 'Vacancy' } & Pick<
	Vacancy,
	'description'
> &
	VacancyInfoFragment;

export type VacancyInfoSnippetFragment = { __typename?: 'Vacancy' } & {
	snippet?: Maybe<{ __typename?: 'Snippet' } & SnippetInfoFragment>;
} & VacancyInfoFragment;
...
export type VacancyQuery = { __typename?: 'Query' } & {
	vacancy?: Maybe<
		{ __typename?: 'Vacancy' } & Pick<Vacancy, 'id'> &
...
export type VacanciesQuery = { __typename?: 'Query' } & {
	vacancies?: Maybe<
		{ __typename?: 'Vacancies' } & Pick<
			Vacancies,
			'per_page' | 'page' | 'pages' | 'found'
		> & {
				items?: Maybe<
					Array<
						Maybe<
...
export type SalaryInfoFragment = { __typename?: 'Salary' } & Pick<
	Salary,
	'to' | 'from' | 'currency' | 'gross'
>;

export type SnippetInfoFragment = { __typename?: 'Snippet' } & Pick<
	Snippet,
	'requirement' | 'responsibility'
>;

export type AreaInfoFragment = { __typename?: 'Area' } & Pick<
	Area,
	'id' | 'url' | 'name'
>;

export type LogoUrlsInfoFragment = { __typename?: 'LogoUrls' } & Pick<
	LogoUrls,
	'min' | 'normal' | 'original'
>;

export type EmployerInfoFragment = { __typename?: 'Employer' } & Pick<
	Employer,
	'id' | 'name' | 'url' | 'alternate_url' | 'trusted'
> & { logo_urls?: Maybe<{ __typename?: 'LogoUrls' } & LogoUrlsInfoFragment> };

export type MetroStationInfoFragment = { __typename?: 'MetroStation' } & Pick<
	MetroStation,
	'station_name' | 'line_name' | 'station_id' | 'line_id' | 'lat' | 'lng'
>;

export type AddressInfoFragment = { __typename?: 'Address' } & Pick<
	Address,
	'city' | 'street' | 'building' | 'description' | 'lat' | 'lng'
> & {
		metro_stations?: Maybe<
			Array<Maybe<{ __typename?: 'MetroStation' } & MetroStationInfoFragment>>
		>;
	};
...
export function useVacancyQuery(
	baseOptions: Apollo.QueryHookOptions<VacancyQuery, VacancyQueryVariables>,
) {
	return Apollo.useQuery<VacancyQuery, VacancyQueryVariables>(
		VacancyDocument,
		baseOptions,
	);
}
export function useVacancyLazyQuery(
	...
	return Apollo.useLazyQuery<VacancyQuery, VacancyQueryVariables>(
		VacancyDocument,
		baseOptions,
	);
}
...
export type VacancyQueryResult = Apollo.QueryResult<
	VacancyQuery,
	VacancyQueryVariables
>;
